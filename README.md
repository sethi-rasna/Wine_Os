...
This model will be conducted as a supervised ML model because we want to accept or reject the hypotheis that red wine is healthier and tastier because of higher residual sugar than white wine based on our criteria.
